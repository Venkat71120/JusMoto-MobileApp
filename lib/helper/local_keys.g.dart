...
abstract class LocalKeys {
  ...
  static const String _mapMoveNote = "Longpress and move to select location.";
  ...
  static const String _additionalServices = "Additional Services";
  static const String _stepsAfterBooking = "Setps After Booking";
  static const String _frequentlyAskedQuestions = "Frequently Asked Questions";
  static const String _viewCart = "View Cart";
  static const String _deleteItemFromCart = "Delete item form cart?";
  static const String _thisWillRemoveItemFromCart =
      "This will remove the item from cart.";
  static const String _chooseYourServiceMethod = "Choose Your Service Method";
  ...
  static const String _myCar = "My car";
  static const String _changeCar = "Change Car";
  static const String _carTransmissionType = "Car Transmission Type";
  static const String _carFuelType = "Car Fuel Type";
  static const String _selectYourCar = "Select Your Car";
  static const String _brandList = "Brand list";
  static const String _selectCarBrand = "Select car brand";
  static const String _selectYourCarModel = "Select your car model";
  static const String _searchOutlet = "Search outlet";
  static const String _quantity = "Quantity:";
  static const String _deliveryCharge = "Delivery charge";
  static const String _noCarModelAvailable = "No Car Model Available.";
  static const String _refundPaymentMethod = "Refund payment methods";
  ...
  static const String _orderCancelledSuccessfully = "Order cancel successfully.";
  static const String _refunds = "Refunds";
  static const String _fineAmount = "Fine Amount";
  ...
  static const String _qty = "qty";
  static const String _welcomeBack = "Welcome Back";
  static const String _popularProducts = "Popular Products";
  ...
  static const String _walletBalance = "Wallet Balance";
  static const String _walletTransactions = "Transactions";
  static const String _walletDeposit = "Deposit";
  static const String _addMoney = "Add Money";
  static const String _availableBalance = "Available Balance";
  static const String _withdraw = "Withdraw";
  static const String _transactionHistory = "Transaction History";
  static const String _noTransactionsFound = "No transactions found";
  static const String _enterAmount = "Enter amount";
  static const String _depositSuccess = "Deposit successful";
  static const String _depositPending = "Deposit pending approval";
  static const String _invalidAmount = "Please enter a valid amount";
  static const String _invoiceNumber = "Invoice Number";
...
//getter starts here
  ...
  static String get walletBalance => _walletBalance.tr();
  static String get walletTransactions => _walletTransactions.tr();
  static String get walletDeposit => _walletDeposit.tr();
  static String get addMoney => _addMoney.tr();
  static String get availableBalance => _availableBalance.tr();
  static String get withdraw => _withdraw.tr();
  static String get transactionHistory => _transactionHistory.tr();
  static String get noTransactionsFound => _noTransactionsFound.tr();
  static String get enterAmount => _enterAmount.tr();
  static String get depositSuccess => _depositSuccess.tr();
  static String get depositPending => _depositPending.tr();
  static String get invalidAmount => _invalidAmount.tr();
  static String get invoiceNumber => _invoiceNumber.tr();
  static String get type => _type.tr();
  static String get paymentMethod => _paymentMethod.tr();
  static String get referenceType => _referenceType.tr();
  static String get insufficientWalletBalance => _insufficientWalletBalance.tr();
  static String get searchType => _searchType.tr();
  static String get products => _products.tr();
  static String get featured => _featured.tr();
  static String get assignedStaff => _assignedStaff.tr();
  static String get favorites => _favorites.tr();
  static String get productCategories => _productCategories.tr();
  static String get popularProducts => _popularProducts.tr();
  static String get welcomeBack => _welcomeBack.tr();
  static String get qty => _qty.tr();
  ...
  static String get fineAmount => _fineAmount.tr();
  ...
  static String get noCarModelAvailable => _noCarModelAvailable.tr();
  static String get deliveryCharge => _deliveryCharge.tr();
  static String get quantity => _quantity.tr();
  static String get searchOutlet => _searchOutlet.tr();
  static String get selectYourCarModel => _selectYourCarModel.tr();
  static String get selectCarBrand => _selectCarBrand.tr();
  static String get brandList => _brandList.tr();
  static String get selectYourCar => _selectYourCar.tr();
  static String get carFuelType => _carFuelType.tr();
  static String get carTransmissionType => _carTransmissionType.tr();
  static String get changeCar => _changeCar.tr();
  static String get myCar => _myCar.tr();
  static String get store => _store.tr();
  static String get viewOutletsInMap => _viewOutletsInMap.tr();
  static String get outlet => _outlet.tr();
  static String get selectOutlet => _selectOutlet.tr();
  static String get choseFromMap => _choseFromMap.tr();
  static String get serviceBookingAddressSchedule =>
      _serviceBookingAddressSchedule.tr();
  static String get pickupAndDelivery => _pickupAndDelivery.tr();
  static String get visitOutlet => _visitOutlet.tr();
  static String get chooseYourServiceMethod => _chooseYourServiceMethod.tr();
  static String get thisWillRemoveItemFromCart =>
      _thisWillRemoveItemFromCart.tr();
  static String get deleteItemFromCart => _deleteItemFromCart.tr();
  static String get viewCart => _viewCart.tr();
  static String get frequentlyAskedQuestions => _frequentlyAskedQuestions.tr();
  static String get stepsAfterBooking => _stepsAfterBooking.tr();
  static String get additionalServices => _additionalServices.tr();
  ...
  static final stringsMap = {
    ...
    _viewCart: "",
    _deleteItemFromCart: "",
    _thisWillRemoveItemFromCart: "",
    _chooseYourServiceMethod: "",
    _visitOutlet: "",
    _pickupAndDelivery: "",
    _serviceBookingAddressSchedule: "",
    _choseFromMap: "",
    _selectOutlet: "",
    _outlet: "",
    _viewOutletsInMap: "",
